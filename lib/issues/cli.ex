defmodule Issues.CLI do
  ...
  def args_to_internal_representation([user, project, count ]) when is_binary(count), do: {user, project, String.to_integer(count)}
  def args_to_internal_representation([user, project, count ]), do: {user, project, count}
